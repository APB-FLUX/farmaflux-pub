...
* [doc] [ASSURPHARMA Integration Specification v2.3.1](<ASSURPHARMA - Integration Specifications/ASSURPHARMA_IntegrationSpecification_v2.3.1.docx>)
* [pdf] [ASSURPHARMA_IntegrationSpecification_v2.3.1](<ASSURPHARMA - Integration Specifications/ASSURPHARMA_IntegrationSpecification_v2.3.1.pdf>)
...
- Source: [FARMAFLUX - SMC Specifications](<FARMAFLUX - SMC Specifications>)
...
- Source: [ASSURPHARMA - Application Design](<ASSURPHARMA - Application Design>)


#### BVAC Document message formats
- Abbreviation	BVAC Document Format
- Source:	[Bijlage 3 - Panoramix - message format3 - update 2023](<ASSURPHARMA - BVAC xml/Bijlage 3 - Panoramix - message format3 - update 2023.xlsx>)
...
#### AssurPharma CBFA Configuration
 - Abbreviation:	CBFA Configuration
    - Source: [xsd](<ASSURPHARMA - xsd/assurharma-bvac-configuration.xsd>)
...
#### Assuralia Identification  Insurers 
- Abbreviation:	Assuralia Identification Insurer
- Source	
  - [Full] [Assuralia Identificatie verzekeraars CBFA Panoramix - technical registration parameters - 13-09-2013.xlsx](<ASSURPHARMA - BVAC xml/Assuralia Identificatie verzekeraars CBFA Panoramix - technical registration parameters - 13-09-2013.xlsx>) (:information_source: *updated list of insurers to be supplied* )
  - [Pilot] [Assuralia Identification Insurers - Pilot](<ASSURPHARMA - BVAC xml/Assuralia Identification Insurers - Pilot.xlsx>)


#### TIP System Services
- Abbreviation:	TIP System Services
- Source	
  - [xsd] [system-services.xsd](<ASSURPHARMA - xsd/system-services.xsd>)
  - [xml] [system-services-sample.xml](<ASSURPHARMA - xsd/system-services-sample.xml>)


#### GetBVAC WebService Error Messages
